...
const { protect,protectLawyer } = require("../middleware/authMiddleware");

// Protected routes - all routes require authentication
router.use(protectLawyer);
...
router.get("/Status", getAppointmentsByStatus); // Filtered by status (must be last) // Inside LawyerAppointmentRoutes.js
//router.get("/", protectLawyer, getAppointmentsByStatus); 
