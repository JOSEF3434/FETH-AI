        ...
        <div className="flex justify-end mb-6">
          <div className="inline-flex rounded-md shadow-sm">
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-l-lg border ${language === "en"
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-r-lg border ${language === "am"
                ? "bg-indigo-600 text-white border-indigo-600"
                : "bg-white text-gray-700 border-gray-300 hover:bg-gray-50"
                }`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="relative" ref={typeDropdownRef}>
            ...
            >
              ...
              <FiChevronDown
                className={`text-gray-500 transition-transform ${isTypeDropdownOpen ? "rotate-180" : ""
                  }`}
              />
            </button>
            {isTypeDropdownOpen && (
          ...
          {type && (
            <div className="relative" ref={subclassDropdownRef}>
              ...
              >
                ...
                <FiChevronDown
                  className={`text-gray-500 transition-transform ${isSubclassDropdownOpen ? "rotate-180" : ""
                    }`}
                />
              </button>
          ...
          <div className="mb-8">
            ...
            <div className="relative">
              ...
              <button
                ...
                className={`absolute right-3 bottom-3 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white ${isLoading || !searchQuery.trim()
          ...
          <div className="bg-gray-50 rounded-xl p-6 shadow-inner border border-gray-200">
            ...
            <div className="mb-8">
              ...
              <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 mb-4">
                {response.isFallback ? (
                  <div
                    className={`${response.isDatabaseFallback
                  ...
                  >
                    <div className="flex">
                      <div className="flex-shrink-0">
                        <svg
                          className={`h-5 w-5 ${response.isDatabaseFallback
                            ? "text-blue-400"
                            : "text-yellow-400"
                            }`}
                          viewBox="0 0 20 20"
                      ...
                      <div className="ml-3">
                        <p
                          className={`text-sm ${response.isDatabaseFallback
                            ? "text-blue-700"
                            : "text-yellow-700"
                            }`}
                        >
                        ...
                        {response.nextSteps && response.nextSteps.length > 0 && (
                          <div className="mt-2">
                            <ul
                              className={`list-disc pl-5 text-sm ${response.isDatabaseFallback
                                ? "text-blue-700"
                                : "text-yellow-700"
                                }`}
                            >
